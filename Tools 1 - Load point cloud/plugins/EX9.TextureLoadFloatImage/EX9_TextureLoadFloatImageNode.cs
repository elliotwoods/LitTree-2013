...
{
	#region PluginInfo
	[PluginInfo(Name = "LoadFloatImage", Category = "EX9.Texture", Help = "Basic template which creates a texture", Tags = "")]
	#endregion PluginInfo
	public class EX9_TextureLoadFloatImageNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
